...
def evaluate_numbers(target_value, numbers, current_sum = 0)
  ...
  return evaluate_numbers(target_value, adjusted_numbers, current_sum + next_value) || evaluate_numbers(target_value, adjusted_numbers, current_sum * next_value) || evaluate_numbers(target_value, adjusted_numbers, (current_sum.to_s + next_value.to_s).to_i)
end
